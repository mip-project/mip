...
(function (global, factory) {
...

  {
      ...
      tip = function tip(msg, vm) {
          if (hasConsole && !config.silent) {
              console.warn('[MIP tip]: ' + msg + (vm ? generateComponentTrace(vm) : ''));
          }
      };
      ...
      formatComponentName = function formatComponentName(vm, includeFile) {
          ...
          var options = typeof vm === 'function' && vm.cid != null ? vm.options : vm._isMIP ? vm.$options || vm.constructor.options : vm || {};
          var name = options.name || options._componentTag;
          var file = options.__file;
          if (!name && file) {
              var match = file.match(/([^/\\]+)\.mip$/);
              name = match && match[1];
          }
  ...
  // detect devtools
  var devtools = inBrowser && window.__MIP_DEVTOOLS_GLOBAL_HOOK__;
  ...
  function observe(value, asRootData) {
      ...
      if (hasOwn(value, '__ob__') && value.__ob__ instanceof Observer) {
          ob = value.__ob__;
      } else if (observerState.shouldConvert && !isServerRendering() && (Array.isArray(value) || isPlainObject(value)) && Object.isExtensible(value) && !value._isMIP) {
  ...
  function set$1(target, key, val) {
      ...
      if (target._isMIP || ob && ob.vmCount) {
          warn('Avoid adding reactive properties to a MIP instance or its root $data ' + 'at runtime - declare it upfront in the data option.');
          return val;
      }
  ...
  function del(target, key) {
      ...
      var ob = target.__ob__;
      if (target._isMIP || ob && ob.vmCount) {
          warn('Avoid deleting properties on a MIP instance or its root $data ' + '- just set it to null.');
          return;
      }
  ...
  function mountComponent(vm, el, hydrating) {
      ...
      if (!vm.$options.render) {
          vm.$options.render = createEmptyVNode;
          {
              ...
              if (vm.$options.template && vm.$options.template.charAt(0) !== '#' || vm.$options.el || el) {
                  warn('You are using the runtime-only build of MIP where the template ' + 'compiler is not available. Either pre-compile the templates into ' + 'render functions, or use the compiler-included build.', vm);
              } else {
      ...
      if (config.performance && mark) {
          updateComponent = function updateComponent() {
              var name = vm._name;
              var id = vm._uid;
              var startTag = 'mip-perf-start:' + id;
              var endTag = 'mip-perf-end:' + id;
      ...
      for (var key in methods) {
          {
              ...
              if (key in vm && isReserved(key)) {
                  warn('Method "' + key + '" conflicts with an existing MIP instance method. ' + 'Avoid defining component methods that start with _ or $.');
              }
          }
  ...
  function stateMixin(MIP) {
      ...
      MIP.prototype.$set = set$1;
      MIP.prototype.$delete = del;

      MIP.prototype.$watch = function (expOrFn, cb, options) {
          var vm = this;
          if (isPlainObject(cb)) {
  ...
  function createComponent(Ctor, data, context, children, tag) {
      ...
      var vnode = new VNode('mip-component-' + Ctor.cid + (name ? '-' + name : ''), data, undefined, undefined, undefined, context, { Ctor: Ctor, propsData: propsData, listeners: listeners, tag: tag, children: children }, asyncFactory);
      return vnode;
  }
  ...
  function renderMixin(MIP) {
      ...
      MIP.prototype._render = function () {
          ...
          var _vm$$options = vm.$options,
              ...
              $parentVnode = _vm$$options.$parentVnode;
  ...
  function initExtend(MIP) {
      ...
      MIP.extend = function () {
          ...
          var Sub = function MIPComponent(options) {
              this._init(options);
          };
  ...
  function initAssetRegisters(MIP) {
  ...
  function initGlobalAPI(MIP) {
      ...
      // configDef.get = () => config;
      {
          configDef.set = function () {
              warn('Do not replace the MIP.config object, set individual fields instead.');
          };
      }
  ...
  function registerCustomElement(tag) {
      ...
      if (isES2015$1) {
          ...
          var CustomElement = function (_CustomElement2) {
              inherits(CustomElement, _CustomElement2);
              ...
              function CustomElement(self) {
                  ...
                  return _ret = me, possibleConstructorReturn(_this, _ret);
              }

              createClass(CustomElement, null, [{
          ...
          return _CustomElement3; // eslint-disable-line consistent-return
      }
  }
  ...
  }; // eslint-disable-line arrow-parens, no-confusing-arrow
  ...
  function convertAttributeValue(attr, overrideType, element) {
  ...
  function getPropsData(element, componentDefinition, props) {
      ...
      props.hyphenate.forEach(function (name, index) {
          ...
          propsData[propCamelCase] = propValue instanceof Attr ? convertAttributeValue(propValue, type, element) : propValue;
      });
  ...
  function getAttributes(children) {
      ...
      toArray$2(children.attributes).forEach(function (attribute) {
  ...
  function getSlots() {
      ...
      var slots = [];
      toArray$2(children).forEach(function (child) {
      ...
      if (!element.__vue_custom_element__) {
          ...
          var beforeCreate = function beforeCreate() {
              ...
              this.$emit = function emit() {
                  ...
                  this.__proto__ && (_proto__$$emit = this.__proto__.$emit).call.apply(_proto__$$emit, [this].concat(args)); // eslint-disable-line no-proto
              };
          };
          ...
          if (ComponentDefinition._compiled) {
              ...
              var ctorOptions = {}; // adjust vue-loader cache object if necessary - https://github.com/vuejs/vue-loader/issues/83
          ...
          if (vueVersion >= 2) {
              var elementOriginalChildren = element.cloneNode(true).childNodes; // clone hack due to IE compatibility
              // Vue 2+
              rootElement = {
                  propsData: propsData,
  ...
  function buildInComponents (MIP) {
  ...
  function createPatchFunction(backend) {
                  ...
                  if (!elm.hasChildNodes()) {
                      ...
                      if (isDef(i = data) && isDef(i = i.domProps) && isDef(i = i.innerHTML)) {
                          if (i !== elm.innerHTML) {
                              ...
                              /* istanbul ignore if */
                              if (typeof console !== 'undefined' && !bailed) {
                                  bailed = true;
                                  /* eslint-disable */
      ...
      function assertNodeMatch(node, vnode) {
          if (isDef(vnode.tag)) {
              return vnode.tag.indexOf('mip-component') === 0 || vnode.tag.toLowerCase() === (node.tagName && node.tagName.toLowerCase());
          }
  ...
  /* istanbul ignore next */
  MIP.nextTick(function () {
      if (config.devtools) {
          if (devtools) {
              devtools.emit('init', MIP);
          } else if (isChrome) {
              console[console.info ? 'info' : 'log']('Download the MIP Devtools extension for a better development experience:\n' + 'https://github.com/vuejs/mip-devtools');
          }
      }

      if (config.productionTip !== false && inBrowser && typeof console !== 'undefined') {
          console[console.info ? 'info' : 'log']('You are running MIP in development mode.\n' + 'Make sure to turn on production mode when deploying for production.\n' + 'See more tips at https://vuejs.org/guide/deployment.html\n');
      }
  }, 0);
  ...
  function parse(template, options) {
      ...
      parseHTML(template, {
          ...
          start: function start(tag, attrs, unary) {
              ...
              for (var _i = 0; _i < postTransforms.length; _i++) {
                  postTransforms[_i](element, options);
              }
          },
          end: function end() {
  ...
  function genHandlers(events, isNative, warn) {
      ...
      for (var name in events) {
          ...
          if (name === 'click' && handler && handler.modifiers && handler.modifiers.right) {
  ...
  function bind$1(el, dir) {
      el.wrapData = function (code) {
          return '\n        _b(' + code + ',\'' + el.tag + '\',' + dir.value + ',' + (dir.modifiers && dir.modifiers.prop ? 'true' : 'false') + (dir.modifiers && dir.modifiers.sync ? ',true' : '') + ')';
      };
  }
      ...
      return function compileToFunctions(template, options, vm) {
          ...
          /* istanbul ignore if */
          {
              ...
              try {
                  ...
                  if (e.toString().match(/unsafe-eval|CSP/)) {
                      warn$$1('It seems you are using the standalone build of MIP.js in an ' + 'environment with Content Security Policy that prohibits unsafe-eval. ' + 'The template compiler cannot work in this environment. Consider ' + 'relaxing the policy to allow unsafe-eval or pre-compiling your ' + 'templates into render functions.');
                  }
              }
          }
          ...
          // check compilation errors/tips
          {
              if (compiled.errors && compiled.errors.length) {
                  warn$$1('Error compiling template:\n' + template + compiled.errors.map(function (e) {
                      return '- ' + e;
                  }).join('\n') + '\n', vm);
              }
  ...
  var mount = MIP.prototype.$mount;
  MIP.prototype.$mount = function (el, hydrating) {
      el = el && query(el);

      /* istanbul ignore if */
      if (el === document.body || el === document.documentElement) {
          warn('Do not mount MIP to <html> or <body> - mount to normal elements instead.');
          return this;
      }
